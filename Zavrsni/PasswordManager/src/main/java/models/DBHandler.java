...
public class DBHandler {
    ...
    public static void addPasswordToPasswordsClass(User user, String website, String username, String password) {

        Passwords passwordsClass = user.getPasswordsClass();
        Map<String, Map<String, String>> mapa = new HashMap<>();
        mapa.put(website, Map.of(username, password));
        passwordsClass.setPasswords(mapa);
        System.out.println(passwordsClass);
    }
}
